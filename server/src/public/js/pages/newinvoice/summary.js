	...
	<React.Fragment>
				...
				type === "good" ? 
					...
					<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						{data.milestones.map(({ amount, description, dueDate }, i) => (
							<div key={i} className="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-line-bottom">
								<div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 ">{amount}</div>
								<div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">{description}</div>
								<div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">{dueDate}</div>
							</div>
						))}
					</div>
			}
		...
		<div className="form-buttons">
			<input
				...
				onClick={back}
			/>
			<input onClick={submit} type="submit" value="SEND" id="send" className="text-submit" />
		</div>
	</React.Fragment>
);
