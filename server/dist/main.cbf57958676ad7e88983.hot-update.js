...
var verifyToken = function verifyToken(req, res, next) {
    ...
    var authorization = req.headers['x-authorization'];
    ...
    if (req.originalUrl.match('/api/invoice') !== null && req.method.toLowerCase() === 'get' || req.originalUrl.match('/api/payment') !== null && req.method.toLowerCase() === 'post' || req.originalUrl.match('/api/payment') !== null && req.method.toLowerCase() === 'get' || req.originalUrl.match('/api/banks') !== null && req.method.toLowerCase() === 'get' || req.originalUrl.match('/api/dispute') !== null && req.method.toLowerCase() === 'post' || req.originalUrl.match('/api/dispute') !== null && req.method.toLowerCase() === 'get' || req.originalUrl.match('/api/verify') !== null && req.method.toLowerCase() === 'get') {
        next();
        return;
    }
...
//# sourceMappingURL=main.cbf57958676ad7e88983.hot-update.js.map