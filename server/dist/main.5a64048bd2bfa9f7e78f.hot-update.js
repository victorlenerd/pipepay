...
/* harmony default export */ __webpack_exports__["default"] = (Object(_modules_generateController__WEBPACK_IMPORTED_MODULE_8__["default"])(_payment_model__WEBPACK_IMPORTED_MODULE_5__["default"], {
    createOne: function createOne(req, res) {
        ...
        if (hash === req.headers['x-paystack-signature'] && event === 'invoice.update' && paid) {
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 2:
                                    _context.prev = 2;
                                    _context.next = 5;
                                    return Object(_modules_transfer__WEBPACK_IMPORTED_MODULE_9__["default"])(doc['marchantName'], doc['marchantAccountNumber'], doc['marchantBankCode'], doc['deliveryAmount'] * 100);

                                case 5:
                                    _context.next = 7;
                                    return _payment_model__WEBPACK_IMPORTED_MODULE_5__["default"].create({ customerEmail: email, marchantEmail: doc['marchantEmail'], reference: reference, amount: amount, invoiceId: doc._id });
            ...
            _payment_model__WEBPACK_IMPORTED_MODULE_5__["default"].create({ customerEmail: email, reference: reference, amount: amount, invoiceId: invoice_code }, function (err) {
...
//# sourceMappingURL=main.5a64048bd2bfa9f7e78f.hot-update.js.map