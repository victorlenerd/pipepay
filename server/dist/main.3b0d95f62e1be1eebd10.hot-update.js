    ...
    createOne: function createOne(req, res) {
        ...
        if (hash === req.headers['x-paystack-signature'] && event === 'charge.success') {
            _payment_model__WEBPACK_IMPORTED_MODULE_5__["default"].create({ customerEmail: email, marchantEmail: marchantEmail, reference: reference, amount: amount, invoiceId: invoiceId }, function (err) {
                ...
                _invoice_invoice_model__WEBPACK_IMPORTED_MODULE_6__["default"].findOneAndupdate({ _id: invoiceId }, { $set: { status: 'paid' } }, {}, function () {
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 2:
                                        _context.prev = 2;
                                        _context.next = 5;
                                        return Object(_modules_transfer__WEBPACK_IMPORTED_MODULE_9__["default"])();
...
//# sourceMappingURL=main.3b0d95f62e1be1eebd10.hot-update.js.map