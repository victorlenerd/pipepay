                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _context2.next = 5;
                            return babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_3___default.a.all([sendTo(babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, mailOption, { to: customerEmail, text: 'Your dispute has been received, you will hear from our support rep soon.' })), sendTo(babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, mailOption, { to: marchantEmail, text: 'New dispute from ' + customerName + ' reason being that: "' + reason + '"' })), sendTo(babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, mailOption, { to: supportEmail, text: 'New dispute from ' + customerEmail + ' reason being that: "' + reason + '"' }))]);
...
//# sourceMappingURL=main.93b6e13d7a0fe714a942.hot-update.js.map