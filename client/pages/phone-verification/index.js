...
{this.state.boxFour.focus();}
  ...
  render(){
	...
	<div className="form">
		<form>
			<input type="text" name="first" maxlength="1" class="pin" onKeyUp={this.handleBox1}></input>
			<input type="text" name="second" maxlength="1" class="pin" onKeyUp={this.handleBox2}></input>
			<input type="text" name="third" maxlength="1" class="pin" onKeyUp={this.handleBox3}></input>
			<input type="text" name="fourth" maxlength="1" class="pin" onKeyUp={this.handleBox4}></input>
		</form>
	</div>
	<div id="verify">
